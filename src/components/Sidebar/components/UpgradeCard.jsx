...
const UpgradeCard = () => {
  return (
    <div className="relative flex w-[269px] h-[243px] justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-darkBlue-500 pb-4">
      <div className="absolute -top-12 flex h-24 w-24 items-center justify-center rounded-full border-[4px] border-white bg-gradient-to-b from-[#868CFF] to-darkBlue-500 dark:!border-navy-800">
        <svg
          width="41"
          height="41"
          viewBox="0 0 41 41"
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        ...
        <a
          target="blank"
          className="text-medium mt-7 block rounded-full py-[12px] px-11 text-center text-base text-white hover:bg-white/20 bg-white/15 "
